...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(32*8*8, 1000) # FC(32*8*8x1000)
        self.fc2 = nn.Linear(1000, 6) # FC(1000x6)
    ...
    def forward(self, X):
        ...
        X = X.view(-1, 32*8*8) # Negative one so we can vary the batch size. # Flatten to (batch_size, 32*8*8)
...
torch.save(model.state_dict(), "modelo_final_CNN4.pth")
